...
<template>
  <div class="card card-template">
    <div class="card-header">
      <h2>Basic</h2>
      <component :is="Switch" v-model="codeToggle" label="code" />
    </div>
    <div>
      <p>
    ...
    <div class="flex gap-4">
      <button class="btn btn-base btn-primary" @click="showModal = true">Open Modal</button>
        ...
        <template #content>
          <div class="max-h-90vh overflow-auto p-4">
            ...
            <div class="space-y-8">
              ...
              <button class="btn btn-danger btn-block" @click="showModal = false">Close</button>
            </div>
          </div>
        </template>
      </component>
