<template>
  <div class="main-content-container">
    <div class="main-content-header">
      ...
      <component
        :is="Breadcrumb"
        :breadcrumbs="[{ name: 'template' }, { name: 'component' }, { name: 'modal' }]"
      />
    </div>
    <div class="card p-4 space-y-5">
      ...
      <div>
        <div>
          <button
            class="btn btn-base bg-slate-100 font-medium text-slate-800 active:bg-slate-200/80 dark:bg-slate-500 focus:bg-slate-200 hover:bg-slate-200 dark:text-slate-50 dark:active:bg-slate-500/90 dark:focus:bg-slate-500 dark:hover:bg-slate-500"
          ...
          <component :is="BaseModal" :is-open="showModal" @on-close="showModal = false">
            <template #content>
              <div class="mt-4">
                ...
                <button
                  class="btn mt-6 bg-success font-medium text-white active:bg-success-focus/90 focus:bg-success-focus hover:bg-success-focus"
